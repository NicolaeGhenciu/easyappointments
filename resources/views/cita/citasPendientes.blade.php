    ...
    <script>
        $(document).ready(function() {
            ...
            $('#borrarModal').on('show.bs.modal', function(event) {
                ...
                // poner los datos en el modal
                $('#borrar_nombre_empresa').text(cita.empresa.nombre);
                $('#borrar_cif').text(cita.empresa.cif);
                $('#borrar_telefono_empresa').text(cita.empresa.telefono);
                $('#borrar_nif_empleado').text(cita.empleado.nif);
                $('#borrar_nombre_empleado').text(cita.empleado.nombre + " " + cita.empleado.apellidos);
                $('#borrar_cargo').text(cita.empleado.cargo);
                $('#borrar_cod').text(cita.servicio.cod);
                $('#borrar_nombre_servicio').text(cita.servicio.nombre);
                $('#borrar_precio').text(cita.servicio.precio);
                $('#borrar_duracion').text(cita.servicio.duracion);
                $('#borrar_nif_cliente').text(cliente.nif);
                $('#borrar_nombre_cliente').text(cliente.nombre + " " + cliente.apellidos);
                $('#borrar_fecha_inicio').text(obtenerFechaFormateada(cita.fecha_inicio));
                $('#borrar_fecha_fin').text(obtenerFechaFormateada(cita.fecha_fin));
                $('#borrar_estado').text(cita.status);
                $('#borrar-form').submit(function() {
                    var url = "{{ route('cancelarCita', ['id' => ':idcita']) }}";
                    url = url.replace(':idcita', cita.id_cita);
                    $('#borrar-form').attr('action', url);
                });
            });
        });
                            ...
                            <div class="btn-group btn-group-md gap-1">
                                ...
                                <span data-bs-toggle="tooltip" data-bs-placement="top" title="Cancelar">
                                    <a class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#borrarModal"
                                        data-cita="{{ $cita }}" data-cliente="{{ $cita->cliente }}">
                                        <i class="bi bi-calendar-x-fill"></i></a></span>
                            </div>
                        </td>
                    </tr>
                @endforeach
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="card mb-3">
                                    ...
                                    <div class="card-body">
                                        <p><strong>Nombre:</strong> <span id="borrar_nombre_empresa"></span></p>
                                        <p><strong>CIF:</strong> <span id="borrar_cif"></span></p>
                                        <p><strong>Teléfono:</strong> <span id="borrar_telefono_empresa"></span></p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="card mb-3">
                                    ...
                                    <div class="card-body">
                                        <p><strong>NIF:</strong> <span id="borrar_nif_empleado"></span></p>
                                        <p><strong>Nombre y apellidos:</strong> <span id="borrar_nombre_empleado"></span>
                                        </p>
                                        <p><strong>Cargo:</strong> <span id="borrar_cargo"></span></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="card mb-3">
                                    ...
                                    <div class="card-body">
                                        <p><strong>Código:</strong> <span id="borrar_cod"></span></p>
                                        <p><strong>Nombre:</strong> <span id="borrar_nombre_servicio"></span></p>
                                        <p><strong>Precio:</strong> <span id="borrar_precio"></span> €</p>
                                        <p><strong>Duración:</strong> <span id="borrar_duracion"></span> minutos</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="card mb-3">
                                    ...
                                    <div class="card-body">
                                        <p><strong>NIF:</strong> <span id="borrar_nif_cliente"></span></p>
                                        <p><strong>Nombre y apellidos:</strong> <span id="borrar_nombre_cliente"></span>
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="card mb-3">
                                    ...
                                    <div class="card-body">
                                        <p><strong>Fecha de inicio:</strong> <span id="borrar_fecha_inicio"></span></p>
                                        <p><strong>Fecha de fin:</strong> <span id="borrar_fecha_fin"></span></p>
                                        <p><strong>Estado:</strong> <span id="borrar_estado"></span></p>
                                    </div>
                                </div>
                            </div>
                        </div>
