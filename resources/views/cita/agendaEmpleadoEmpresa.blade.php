    ...
    <script>
        ...
        function modificar() {
            ...
            $('#modificar-cita-form').submit(function() {
                var url =
                    "{{ route('modificarCitaE_Empresa', ['id' => ':idcita', 'idEmpleado' => ':idempleado']) }}";
                url = url.replace(':idcita', cita.id_cita);
                url = url.replace(':idempleado', {{ $id }});
    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col text-center">
                <h3>Agenda - {{ $empleado->nombre }} {{ $empleado->apellidos }} - NIF: {{ $empleado->nif }}</h3>
            </div>
        </div>
    </div>
    <hr>
    ...
    <div class="modal fade" id="añadirModal" tabindex="-1" aria-labelledby="añadirModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('nuevaCitaE_Empresa', ['id' => $id]) }}" method="post">
                        @csrf
                        <div class="row mb-3">
